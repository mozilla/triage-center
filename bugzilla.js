...
function setup_queries() {
  ...
  var stale_decision = make_search({
    ...
    o1: "nowords",
    chfield: "[Bug creation]",
    chfieldfrom: "2016-10-19", // change to date of first nightly of next version at release
    f1: "cf_status_firefox52", // change to next version at release
    resolution: "---",
    query_format: "advanced"
  }, common_params);
  ...
  var stale_range = make_search({
    ...
    chfieldfrom: "2016-10-19", // change to date of first nightly of next version at release
    chfieldto: "Now",
    f1: "cf_status_firefox52", // increment version numbers at release 
    f2: "cf_status_firefox53",
    f3: "cf_status_firefox54",
    j_top: "OR",
    keywords: "regression",
    keywords_type: "allwords",
    o1: "nowords",
