...
function setup_queries() {
  ...
  var to_triage = make_search({
    ...
    chfieldfrom: "2019-01-28", // Change to first nightly of current release
  }, common_params);
  ...
  var stale_decision = make_search({
    ...
    o1: "nowords",
    chfield: "[Bug creation]",
    chfieldfrom: "2019-03-18", // change to date of first nightly of next version at release
    f1: "cf_status_firefox68", // change to next version at release
    resolution: "---",
    query_format: "advanced"
  }, common_params);
  ...
  var stale_range = make_search({
    chfield: "[Bug creation]",
    chfieldfrom: "2018-03-18", // change to date of first nightly of next version at release
    chfieldto: "Now",
    f1: "cf_status_firefox68", // increment version numbers at release
